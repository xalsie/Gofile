...
import type { UploadResult, FileToUpload, MultipleUploadResult } from '../types/index.js';
  ...
  async uploadMultipleFiles(
    ...
    try {
      ...
      return {
        ...
        results,
        folderId,
        downloadPage: folderResponse.data.code ? `https://gofile.io/d/${folderResponse.data.code}` : undefined,
        error: allSuccess ? undefined : `${successCount}/${files.length} files uploaded successfully`
      };
