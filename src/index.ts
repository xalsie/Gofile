...
import type { GofileConfig, UploadResult, FileToUpload, MultipleUploadResult, AuthenticatedConfig } from './types/index.js';
...
export type { GofileConfig, UploadResult, FileToUpload, MultipleUploadResult, AuthenticatedConfig } from './types/index.js';
